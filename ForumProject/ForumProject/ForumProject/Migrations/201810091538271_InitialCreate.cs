namespace ForumProject.Migrations
{
    ...
    public partial class InitialCreate : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        MainCategoryByCitiesId = c.Int(nullable: false),
                    })
                .PrimaryKey(t => t.IntermediateCategoryId)
                .ForeignKey("dbo.MainCategoryByCities", t => t.MainCategoryByCitiesId, cascadeDelete: true)
                .Index(t => t.MainCategoryByCitiesId);
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.IntermediateCategories", "MainCategoryByCitiesId", "dbo.MainCategoryByCities");
            ...
            DropIndex("dbo.IntermediateCategories", new[] { "MainCategoryByCitiesId" });
